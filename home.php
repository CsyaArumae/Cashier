...
<body class="g-sidenav-show  bg-gray-100">
                    ...
                    <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active " href="menu_makanan.php" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                                        ...
                                        <span class="ms-1">❥ Delicious</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " href="menu_makanan.php" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Transaction</p>
                    <div class="col-md-11">
                    <?php
                                        include "koneksi.php";
                                        $sql = mysqli_query($koneksi, "SELECT * FROM transaksi");
                                    ?>
                                    <h5 class="font-weight-bolder mb-0"><?= mysqli_num_rows($sql) ?></h5>
                                </div>
                      <br>
                      <span class="text-success text-sm font-weight-bolder">+<?= mysqli_num_rows($sql) ?>%</span>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                  <p class="text-sm mb-0 text-capitalize font-weight-bold">Table's Available</p>
                    <div class="col-md-11">
                    <?php
                                        include "koneksi.php";
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                  <p class="text-sm mb-0 text-capitalize font-weight-bold">Total's Sales</p>
                    <div class="col-md-11">
                    <?php
                                        include "koneksi.php";
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                  <p class="text-sm mb-0 text-capitalize font-weight-bold">Our Cashier</p>
                    <div class="col-md-11">
                    <?php
                                        include "koneksi.php";
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-11">
            <!-- <?php
                    include "koneksi.php";
                    $sql_harga = mysqli_query($koneksi, "SELECT SUM(harga) as harga FROM detail_transaksi");
                    $harga = mysqli_fetch_array($sql_ttl);
                    ?> -->
            <h2 class="text-muted font-semibold">Total Pendapatan : Rp. <?= $harga['harga'] ?>,-</h2>
        </div>
        </body>
<?php
include "footer.php";
